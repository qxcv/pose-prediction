...
if params['use_cond']:
    ...
    print('Not using conditional information')
    train_cond_vals = val_cond_vals = None
params['savedir'] += '-mpii-ca2'
...
from stinfmodel_fast.dkf import DKF  # noqa
import stinfmodel_fast.learning as DKF_learn  # noqa
import stinfmodel_fast.evaluate as DKF_evaluate  # noqa
