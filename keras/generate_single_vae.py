...
def make_decoder(pose_size):
    # TODO: Add batch norm to LITERALLY EVERYTHING (assuming it speeds
    # convergence)
...
def make_vae(pose_size):
    ...
    vae_opt = Adam(lr=LR, beta_1=BETA_1)
...
if __name__ == '__main__':
    ...
    model = train_model(train_X, val_X)
